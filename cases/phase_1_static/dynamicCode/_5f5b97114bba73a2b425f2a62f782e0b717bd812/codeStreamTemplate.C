...
extern "C"
{
    void codeStream_5f5b97114bba73a2b425f2a62f782e0b717bd812
    (
        Ostream& os,
...
//{{{ begin code
	   ...
	   point oWE(-5*chord, 0, 0);
           point oNE1(xMid, 5*chord, 0);
           point oNE2(chord, 5*chord, 0);
           point oNE3(11*chord, 5*chord, 0);
	   point oSE1(xMid, -5*chord, 0);
	   point oSE2(chord, -5*chord, 0);
           point oSE3(11*chord, -5*chord, 0);
           point oEE(11*chord, 0, 0);
