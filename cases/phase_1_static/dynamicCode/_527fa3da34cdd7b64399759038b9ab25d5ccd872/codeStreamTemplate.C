...
extern "C"
{
    void codeStream_527fa3da34cdd7b64399759038b9ab25d5ccd872
    (
        Ostream& os,
...
//{{{ begin code
	    ...
	    const point upperEllipse(-2*chord, 4.5047*chord, 0);
	    const point lowerEllipse(-2*chord, -4.5047*chord, 0);
